# TODO Refactor as Pytest native
...
class Test_get_multi_cpu_settings(TestCaseImporter):
    ...
    def test_get_multi_cpu_settings__disables_multiprocessing_if_either_core_count_or_core_limit_is_one(
        self,
    ) -> None:
    ...
    def test_get_multi_cpu_settings__sets_cpu_count_to_cpu_count_minus_two_if_omitted(
        self,
    ) -> None:
        from darwin.importer.importer import _get_multi_cpu_settings as gmcus
    ...
    def test_get_multi_cpu_settings__sets_cpu_count_to_cpu_count_if_greater_that_total_available_passed(
        self,
    ) -> None:
        from darwin.importer.importer import _get_multi_cpu_settings as gmcus
